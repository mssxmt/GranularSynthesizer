...
private let log = Logger(subsystem: "com.mssxmt.GranularSynthesizerExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<GranularSynthesizerExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try GranularSynthesizerExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? GranularSynthesizerExtensionAudioUnit else {
            log.error("Unable to create GranularSynthesizerExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(GranularSynthesizerExtensionParameterSpecs.createAUParameterTree())
