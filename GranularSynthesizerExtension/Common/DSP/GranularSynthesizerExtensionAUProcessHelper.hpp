//
//  GranularSynthesizerExtensionAUProcessHelper.hpp
...
#include <vector>
#include "GranularSynthesizerExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(GranularSynthesizerExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    GranularSynthesizerExtensionDSPKernel& mKernel;
